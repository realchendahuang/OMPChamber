...
export const assertUpdaterCapability = ({
  ...
  if (!appImagePath) {
    throw new Error(
      'Updates require the packaged Linux AppImage. Start OMPChamber from its .AppImage file, not an extracted or repackaged copy.',
    );
  }
  ...
  try {
    ...
    throw new Error(`The running AppImage cannot be found at ${appImagePath}. Start OMPChamber from a valid .AppImage file.`);
  }
