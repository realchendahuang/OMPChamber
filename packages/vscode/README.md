...
**Like the extension? There's also a [desktop app and web version](https://github.com/realchendahuang/OMPChamber) with even more features.**
...
Install locally: `code --install-extension packages/vscode/ompchamber-*.vsix`
