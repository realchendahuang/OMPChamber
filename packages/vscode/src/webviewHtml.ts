...
import type { ConnectionStatus } from './serverProcess';
...
<head>
  ...
  <style>
    ...
    /* Glow pulse on the OMPChamber mark on the cube's top face — signals loading without text. */
...
<body>
  ...
  <div id="initial-loading">
    ...
    ${!cliAvailable ? `<div class="error-text" id="cli-missing-text">OMPChamber server failed to start. Check the extension installation.</div>` : ''}
  </div>
  ...
  <script>
    ...
    function getBootstrapMessages() {
      ...
      return locale === 'fr'
        ? {
            startingApi: 'Démarrage du serveur OMPChamber…',
            initializing: 'Initialisation…',
            connecting: 'Connexion…',
            connected: 'Connecté !',
            connectionError: 'Erreur de connexion',
            reconnecting: 'Reconnexion…',
            cliNotFound: 'Le serveur OMPChamber n’a pas démarré. Vérifiez l’installation de l’extension.',
          }
        : {
            startingApi: 'Starting OMPChamber server…',
            initializing: 'Initializing…',
            connecting: 'Connecting…',
            connected: 'Connected!',
            connectionError: 'Connection error',
            reconnecting: 'Reconnecting…',
            cliNotFound: 'OMPChamber server failed to start. Check the extension installation.',
          };
    }
