...
## Polecenie OMPChamber kończy się lub nie uruchamia

- upewnij się, że Node.js `>=22`
- uruchom `ompchamber --version`
- w razie potrzeby zainstaluj ponownie najnowsze CLI

## Webowy interfejs jest nieosiągalny

- sprawdź logi serwera poleceniem `ompchamber logs`
...
- upewnij się, że serwer OMPChamber działa
