...
Provider-Anmeldungen werden von OMP gespeichert, nicht von OMPChamber, daher sind sie mit der OMP-CLI geteilt. Wenn du denselben Provider an mehr als einem Ort einrichtest, gewinnt die spezifischste Einstellung: Eine projektbezogene Einstellung überschreibt deine persönliche.
