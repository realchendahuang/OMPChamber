---
title: Schnellstart
description: Starte OMPChamber schnell und wähle die richtige App für die Aufgabe.
---
...
1. Installiere [OMP](https://github.com/can1357/oh-my-pi).
2. Installiere das OMPChamber-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `ompchamber --ui-password be-creative-here` aus.
...
Du solltest die OMPChamber-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
