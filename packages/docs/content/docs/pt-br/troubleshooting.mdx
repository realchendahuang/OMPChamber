...
## O comando OMPChamber encerra ou não inicia

- confirme o Node.js `>=22`
- execute `ompchamber --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `ompchamber logs`
...
- confirme que o servidor do OMPChamber está em execução
