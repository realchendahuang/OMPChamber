---
title: Reverse Proxy
description: Configure OMPChamber correctly behind Nginx, Nginx Proxy Manager, or another reverse proxy.
---

# Reverse Proxy

Use this page if you run OMPChamber behind Nginx, Nginx Proxy Manager, Caddy, Cloudflare, or another reverse proxy.
