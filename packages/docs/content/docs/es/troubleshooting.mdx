...
## El comando OMPChamber se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `ompchamber --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `ompchamber logs`
...
- confirma que el servidor de OMPChamber está en marcha
