# OMPChamber Docs Source

This package is the source-of-truth for OMPChamber public docs content.
...
Website rendering/deployment happens in `ompchamber-website` (`apps/docs`).
