...
const GITHUB_RELEASES_URL = 'https://github.com/realchendahuang/OMPChamber/releases';
const GITHUB_RELEASES_API_URL = 'https://api.github.com/repos/realchendahuang/OMPChamber/releases';
let cachedDetectedPm = null;

function getSpawnSyncBaseOptions() {
  return process.platform === 'win32' ? { windowsHide: true } : {};
}
const UPDATE_CHECK_URL = process.env.OMPCHAMBER_UPDATE_API_URL || 'https://api.ompchamber.dev/v1/update/check';
