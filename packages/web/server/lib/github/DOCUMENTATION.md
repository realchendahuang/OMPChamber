...
- This module owns GitHub auth, Octokit access, repo resolution, and Pull Request status resolution for OMPChamber.
...
- PR state is persisted in local storage under `ompchamber.github-pr-status`.
