...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("OMPChamber")
...
struct QuickActionsWidget: Widget {
    let kind = "OMPChamberQuickActions"
...
struct LockNewSessionWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .description("Start a new OMPChamber session.")
...
struct LockAttentionWidget: Widget {
    let kind = "OMPChamberLockAttention"
...
@main
struct OMPChamberWidgetBundle: WidgetBundle {
