...
// Control Center control (iOS 18+): tap the OMPChamber logo to start a new session.
//
...
@available(iOS 18.0, *)
struct OMPChamberNewSessionControl: ControlWidget {
    var body: some ControlWidgetConfiguration {
        StaticControlConfiguration(kind: "OMPChamberNewSessionControl") {
...
struct OpenNewSessionIntent: AppIntent {
    static let title: LocalizedStringResource = "New OMPChamber Session"
