...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.opencodeCli.field.agentControlTool',
    descriptionKey: 'settings.ompchamber.opencodeCli.field.agentControlToolInfo',
