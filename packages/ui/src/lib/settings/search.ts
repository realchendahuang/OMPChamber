...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    // Exactly matches the render guard in OMPChamberVisualSettings: any darwin
  ...
  {
    id: 'sessions.omp-binary',
    page: 'general',
    titleKey: 'settings.ompchamber.ompCli.field.binaryPath',
    keywords: ['omp', 'cli', 'binary', 'path'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.omp-update-notifications',
    page: 'general',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.ompchamber.ompCli.field.agentControlTool',
    descriptionKey: 'settings.ompchamber.ompCli.field.agentControlToolInfo',
