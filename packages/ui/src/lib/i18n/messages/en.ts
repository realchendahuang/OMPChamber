...
export const dict = {
  ...
  'aboutDialog.diagnosticsDescription': 'Includes OMPChamber state, OMP health, directories, and projects.',
  ...
  'chat.emptyState.ompUnreachable': 'OMP is not reachable',
  ...
  'ompStatusDialog.description': 'Inspect current OMP status and diagnostics.',
  'ompStatusDialog.actions.copy': 'Copy',
  'ompStatusDialog.empty.noData': 'No data.',
  'ompStatusDialog.toast.copiedTitle': 'Copied',
  'ompStatusDialog.toast.copiedDescription': 'Status copied to clipboard',
  'ompStatusDialog.toast.copyFailed': 'Failed to copy status',
  ...
  'onboarding.localSetup.title': 'Setting Up OMP',
  'onboarding.localSetup.description': 'Install OMP CLI to continue.',
  'onboarding.localSetup.dialog.selectOmpBinary': 'Select OMP binary',
  'onboarding.localSetup.errors.cliNotReady': 'OMP CLI is not ready yet. Please confirm installation is complete and try again.',
  'onboarding.localSetup.errors.detectionFailed': 'Detection failed',
  'onboarding.localSetup.windows.title': 'Windows setup',
  'onboarding.localSetup.windows.stepInstallWsl': 'Install OMP with the command below.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If OMPChamber does not detect OMP automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OMP is the heart of OMPChamber — install it to get started.',
  'onboarding.localSetup.docs.windows': 'OMP docs',
  'onboarding.localSetup.docs.default': 'OMP docs',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'Click to check if OMP CLI is available. If successful, you\'ll automatically enter the main screen.',
  'onboarding.localSetup.status.watching': 'Waiting for OMP',
  'onboarding.localSetup.status.autoContinue': "We'll continue automatically once it's detected.",
  'onboarding.localSetup.field.alreadyInstalled': 'Already installed? Set the OMP CLI path:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to OMPChamber settings and reloads OMP configuration.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'Local OMP Unavailable',
  'onboarding.desktopRecovery.localUnavailable.description': 'OMP CLI could not be started or is not installed. Install OMP or connect to a remote server instead.',
  ...
  'ompUpdate.toast.available.description': 'Version {version} available.',
  'ompUpdate.toast.actions.update': 'Update',
  'ompUpdate.toast.actions.dismiss': 'Dismiss',
  'ompUpdate.toast.actions.reload': 'Reload OMP',
  'ompUpdate.toast.upgrading.title': 'Updating OMP...',
  'ompUpdate.toast.upgrading.description': 'Keep OMPChamber open.',
  'ompUpdate.toast.updated.title': 'OMP updated',
  'ompUpdate.toast.updated.description': 'Update installed.',
  'ompUpdate.toast.updated.descriptionWithVersion': 'Version {version} installed.',
  'ompUpdate.toast.failed.title': 'Could not update OMP',
  'ompUpdate.toast.failed.description': 'The OMP upgrade failed.',
  'ompUpdate.toast.reload.message': 'Restarting OMP...',
