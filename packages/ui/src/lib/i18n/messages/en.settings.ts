export const settingsDict = {
  ...
  'settings.view.actions.reloadOmp': 'Reload OMP',
  'settings.view.actions.reloadOmpTooltip': 'Restart OMP and reload its configuration.',
  'settings.view.actions.applyAndRestartOmp': 'Apply & Restart',
  'settings.view.actions.applyAndRestartOmpTooltipSingle': 'Apply 1 pending configuration change and restart OMP.',
  'settings.view.actions.applyAndRestartOmpTooltipPlural': 'Apply {count} pending configuration changes and restart OMP.',
  'settings.view.pendingRestart.applying': 'Restarting...',
  'settings.view.pendingRestart.applied': 'OMP restarted with pending configuration changes.',
  'settings.view.pendingRestart.applyFailed': 'Failed to apply configuration changes.',
  'settings.view.pendingRestart.manualRestartRequired': 'Saved on disk. Restart your connected OMP server to apply the changes.',
  'settings.view.pendingRestart.saved': 'Saved. Restart OMP to apply.',
  'settings.view.pendingRestart.confirm.title': 'Apply & restart?',
  'settings.view.pendingRestart.confirm.description': 'Restarting OMP will stop any running chats. Your saved configuration changes will take effect after the restart.',
  ...
  'settings.agents.page.toast.savedManualRestart': 'Saved to disk. Restart your connected OMP server to apply the changes.',
  ...
  'settings.agents.page.permissionsEditor.toast.savedRestartRequired': 'Permissions saved — restart the OMP server to apply',
  ...
  'settings.behavior.page.warning.description': 'Changes made here update {path}. OMP also includes any project-level AGENTS.md rules when they exist.',
  ...
  'settings.ompchamber.desktopNetwork.field.minimizeToTrayAria': 'Minimize and close OMPChamber to the system tray',
  'settings.ompchamber.desktopNetwork.field.minimizeToTray': 'Minimize and close to the system tray',
  'settings.ompchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps OMPChamber running in the system tray when the main window is minimized or closed.',
  ...
  'settings.ompchamber.ompCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.ompchamber.ompCli.tooltipSuffix': 'binary.',
  'settings.ompchamber.ompCli.field.binaryPath': 'OMP Binary Path',
  'settings.ompchamber.ompCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/omp',
  'settings.ompchamber.ompCli.field.showUpdateNotifications': 'Show OMP update notifications',
  'settings.ompchamber.ompCli.field.showUpdateNotificationsAria': 'Show OMP update notifications',
  'settings.ompchamber.ompCli.field.agentControlTool': 'Agent control tool',
  'settings.ompchamber.ompCli.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.ompchamber.ompCli.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after Save + Reload.',
  'settings.ompchamber.ompCli.actions.browseAria': 'Browse for OMP binary path',
  'settings.ompchamber.ompCli.actions.browse': 'Browse',
  'settings.ompchamber.ompCli.actions.saveAndReload': 'Save + Reload',
  'settings.ompchamber.ompCli.actions.restartingOmp': 'Restarting OMP…',
  'settings.ompchamber.ompCli.dialog.selectBinaryTitle': 'Select OMP binary',
  'settings.ompchamber.ompCli.tipPrefix': 'Tip: you can also use',
  'settings.ompchamber.ompCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.plugins.toast.reloadFailed': 'OMP reload failed — restart required',
  ...
  'settings.remoteInstances.page.section.mainTunnelDescription': 'Choose the local address used to open this remote OMPChamber server.',
  ...
  'settings.providers.sidebar.empty.description': 'Check your OMP configuration',
  ...
  'settings.providers.page.empty.checkOmpConfiguration': 'Check your OMP configuration',
  ...
  'settings.providers.page.custom.description': 'Add an OpenAI-compatible provider with a base URL, credentials, and model list. Saved to OMP config so it works in chat like any other provider.',
  ...
  'settings.providers.page.custom.field.providerID.info': 'Lowercase letters, numbers, hyphens, and underscores. Used as the OMP provider id.',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OMP auth, not by OMPChamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OMP and never stored by OMPChamber.',
  ...
  'settings.mcp.page.status.description.awaitingRestart': 'This server is saved but not applied yet. Use Apply & Restart to load it into OMP — connect and authorization become available after that.',
  'settings.mcp.page.status.description.connected': 'Connected and ready for OMP to discover tools and resources.',
  'settings.mcp.page.status.description.failedDefault': 'OMP could not reach this MCP server.',
  ...
  'settings.mcp.page.auth.waitingForOmp': 'Waiting for OMP to observe the completed browser authorization flow...',
  ...
  'settings.mcp.page.advanced.timeoutHint': 'Leave blank to use OMP\'s default MCP timeout.',
  ...
  'settings.mcp.page.advanced.oauthHint': 'Leave these fields blank to let OMP infer OAuth settings from the MCP server.',
  ...
  'settings.mcp.page.deleteDialog.descriptionSuffix': 'OMP will need to reload.',
  ...
  'settings.mcp.page.toast.serverCreatedReloadFailed': 'MCP server created, but OMP reload failed.',
  'settings.mcp.page.toast.savedReloadFailed': 'Saved, but OMP reload failed.',
  'settings.mcp.page.toast.retryRefreshHint': 'Retry refresh or reopen Settings before authorizing this server.',
  'settings.mcp.page.toast.serverCreatedReloading': 'MCP server created. OMP reloading…',
  'settings.mcp.page.toast.savedReloading': 'Saved. OMP reloading…',
  'settings.mcp.page.toast.saveFailed': 'Failed to save',
  'settings.mcp.page.toast.unexpectedError': 'An error occurred',
  'settings.mcp.page.toast.serverDeletedReloadFailed': '"{name}" deleted, but OMP reload failed',
  ...
  'settings.mcp.page.toast.ompReloadFailedAfterCallbackSave': 'OMP reload failed after saving the browser callback URL',
  ...
  'settings.ompchamber.defaults.summaryOmpDefault': 'OMP agent default',
