export const settingsDict = {
  ...
  'settings.ompchamber.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.ompchamber.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.ompchamber.opencodeCli.field.agentControlTool': 'Agent control tool',
  'settings.ompchamber.opencodeCli.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.ompchamber.opencodeCli.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after Save + Reload.',
  ...
  'settings.ompchamber.visual.field.macVibrancy': 'Window transparency',
  'settings.ompchamber.visual.field.macVibrancyHint': 'Use the native macOS blur (vibrancy) behind the sidebar. Turn off for fully solid, opaque surfaces.',
