...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 状态、OMP 健康信息、目录和项目。',
  ...
  'chat.emptyState.ompUnreachable': '无法连接 OMP',
  ...
  'ompStatusDialog.title': 'OMP 状态',
  'ompStatusDialog.description': '查看当前 OMP 状态与诊断信息。',
  'ompStatusDialog.actions.copy': '复制',
  'ompStatusDialog.empty.noData': '无数据。',
  'ompStatusDialog.toast.copiedTitle': '已复制',
  'ompStatusDialog.toast.copiedDescription': '状态已复制到剪贴板',
  'ompStatusDialog.toast.copyFailed': '复制状态失败',
  ...
  'onboarding.localSetup.title': '设置 OMP',
  'onboarding.localSetup.description': '安装 OMP CLI 以继续。',
  'onboarding.localSetup.dialog.selectOmpBinary': '选择 OMP 可执行文件',
  'onboarding.localSetup.errors.cliNotReady': 'OMP CLI 尚未就绪。请确认安装完成后重试。',
  'onboarding.localSetup.errors.detectionFailed': '检测失败',
  'onboarding.localSetup.windows.title': 'Windows 设置',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安装 OMP。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自动检测到 OMP，请在下方设置可执行文件路径。',
  'onboarding.localSetup.intro': 'OMP 是 OMPChamber 的核心，先安装它即可开始。',
  'onboarding.localSetup.docs.windows': 'OMP 文档',
  'onboarding.localSetup.docs.default': 'OMP 文档',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '点击检测 OMP CLI 是否可用。成功后将自动进入主界面。',
  'onboarding.localSetup.status.watching': '正在等待 OMP',
  'onboarding.localSetup.status.autoContinue': '检测到后将自动继续。',
  'onboarding.localSetup.field.alreadyInstalled': '已安装？设置 OMP CLI 路径：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '将保存到 OMPChamber 设置并重新加载 OMP 配置。',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本地 OMP 不可用',
  'onboarding.desktopRecovery.localUnavailable.description': 'OMP CLI 无法启动或未安装。请安装 OMP，或改为连接远程服务器。',
  ...
  'ompUpdate.toast.available.description': '版本 {version} 可用。',
  'ompUpdate.toast.actions.update': '更新',
  'ompUpdate.toast.actions.dismiss': '忽略',
  'ompUpdate.toast.actions.reload': '重载 OMP',
  'ompUpdate.toast.upgrading.title': '正在更新 OMP...',
  'ompUpdate.toast.upgrading.description': '请保持 OMPChamber 打开。',
  'ompUpdate.toast.updated.title': 'OMP 已更新',
  'ompUpdate.toast.updated.description': '更新已安装。',
  'ompUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安装。',
  'ompUpdate.toast.failed.title': '无法更新 OMP',
  'ompUpdate.toast.failed.description': 'OMP 升级失败。',
  'ompUpdate.toast.reload.message': '正在重启 OMP...',
  ...
  'ompchamberLogo.aria.logo': 'OMPChamber 标志',
