...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.ompchamberVersionLabel': 'OMPChamber 버전 {version}',
  'aboutDialog.ompVersionLabel': 'OMP 버전 {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'OMPChamber 상태, OMP 상태, 디렉터리 및 프로젝트를 포함합니다.',
  ...
  'chat.emptyState.ompUnreachable': 'OMP에 연결할 수 없음',
  ...
  'ompStatusDialog.title': 'OMP 상태',
  'ompStatusDialog.description': '현재 OMP 상태와 진단 정보를 확인합니다.',
  'ompStatusDialog.actions.copy': '복사',
  'ompStatusDialog.empty.noData': '데이터가 없습니다',
  'ompStatusDialog.toast.copiedTitle': '복사됨',
  'ompStatusDialog.toast.copiedDescription': '상태를 클립보드에 복사했습니다',
  'ompStatusDialog.toast.copyFailed': '상태 복사에 실패했습니다',
  ...
  'onboarding.localSetup.title': 'OMP 설정',
  'onboarding.localSetup.description': '계속하려면 OMP CLI를 설치하세요.',
  'onboarding.localSetup.dialog.selectOmpBinary': 'OMP 바이너리 선택',
  'onboarding.localSetup.errors.cliNotReady': 'OMP CLI가 아직 준비되지 않았습니다. 설치가 완료되었는지 확인하고 다시 시도하세요.',
  'onboarding.localSetup.errors.detectionFailed': '감지에 실패했습니다',
  'onboarding.localSetup.windows.title': 'Windows 설정',
  'onboarding.localSetup.windows.stepInstallWsl': '아래 명령으로 OMP를 설치하세요.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'OMPChamber가 OMP를 자동으로 찾지 못하면 아래에 바이너리 경로를 설정하세요.',
  'onboarding.localSetup.intro': 'OMP는 OMPChamber의 심장입니다. 먼저 설치하고 시작하세요.',
  'onboarding.localSetup.docs.windows': 'OMP 문서',
  'onboarding.localSetup.docs.default': 'OMP 문서',
  ...
  'onboarding.localSetup.helper.checkAndContinue': 'OMP CLI를 사용할 수 있으면 확인을 누르세요. 성공하면 자동으로 메인 화면으로 이동합니다.',
  'onboarding.localSetup.status.watching': 'OMP 대기 중',
  'onboarding.localSetup.status.autoContinue': '감지되면 자동으로 계속됩니다.',
  'onboarding.localSetup.field.alreadyInstalled': '이미 설치되어 있나요? OMP CLI 경로 설정:',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'OMPChamber 설정에 저장하고 OMP 구성을 다시 로드합니다.',
  'onboarding.localSetup.remotePreference': '원격 서버를 사용하시겠어요?',
  'onboarding.localSetup.actions.connectRemoteServer': '리모트 서버 연결 →',
  'onboarding.localSetup.windows.hintInstallInWsl': 'Windows에서는 OMP를 네이티브로 설치하고 실행하세요.',
  'onboarding.localSetup.windows.hintDetectionFailed': '감지에 실패하면 omp.cmd 또는 omp.exe 같은 네이티브 경로를 설정하세요.',
  'onboarding.localSetup.hint.ensurePath': '이미 설치되어 있나요? OMP가 PATH에 있는지 확인하세요.',
  'onboarding.localSetup.hint.setEnv': '또는 `OMP_BINARY` 환경 변수를 설정하세요(`OPENCODE_BINARY`는 더 이상 권장되지 않는 폴백으로 계속 사용할 수 있습니다).',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '로컬 OMP를 사용할 수 없음',
  'onboarding.desktopRecovery.localUnavailable.description': 'OMP CLI를 시작할 수 없거나 설치되어 있지 않습니다. OMP를 설치하거나 원격 서버에 연결하세요.',
  ...
  'ompUpdate.toast.available.title': 'OMP 업데이트',
  'ompUpdate.toast.available.description': '버전 {version} 사용 가능.',
  'ompUpdate.toast.actions.update': '업데이트',
  'ompUpdate.toast.actions.dismiss': '닫기',
  'ompUpdate.toast.actions.reload': 'OMP 다시 로드',
  'ompUpdate.toast.upgrading.title': 'OMP 업데이트 중...',
  'ompUpdate.toast.upgrading.description': 'OMPChamber를 열어 두세요.',
  'ompUpdate.toast.updated.title': 'OMP 업데이트 완료',
  'ompUpdate.toast.updated.description': '업데이트가 설치되었습니다.',
  'ompUpdate.toast.updated.descriptionWithVersion': '버전 {version}이 설치되었습니다.',
  'ompUpdate.toast.failed.title': 'OMP를 업데이트할 수 없음',
  'ompUpdate.toast.failed.description': 'OMP 업그레이드에 실패했습니다.',
  'ompUpdate.toast.reload.message': 'OMP 다시 시작 중...',
  ...
  'ompchamberLogo.aria.logo': 'OMPChamber 로고',
