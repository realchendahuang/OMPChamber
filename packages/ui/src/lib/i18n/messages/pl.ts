...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.emptyState.ompUnreachable': 'OMP jest nieosiągalny',
  ...
  'onboarding.localSetup.title': 'Konfiguracja OMP',
  'onboarding.localSetup.description': 'Zainstaluj CLI OMP aby kontynuować.',
  'onboarding.localSetup.dialog.selectOmpBinary': 'Wybierz binarkę OMP',
  'onboarding.localSetup.errors.cliNotReady': 'OMP CLI nie jest jeszcze gotowy. Potwierdź, że instalacja jest kompletna i spróbuj ponownie.',
  ...
  'onboarding.localSetup.windows.stepInstallWsl': 'Zainstaluj OMP za pomocą poniższego polecenia.',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli OMPChamber nie wykryje OMP automatycznie, ustaw ścieżkę binarki poniżej.',
  'onboarding.localSetup.docs.windows': 'Dokumentacja OMP',
  'onboarding.localSetup.docs.default': 'Wyświetl dokumentację',
  'onboarding.localSetup.actions.checking': 'Sprawdzanie...',
  'onboarding.localSetup.helper.checkAndContinue': 'Kliknij aby sprawdzić czy OMP CLI jest dostępny. Jeśli się uda, automatycznie przejdziesz do głównego ekranu.',
  'onboarding.localSetup.field.alreadyInstalled': 'Juz zainstalowane? Ustaw ścieżkę binarki OMP:',
  'onboarding.localSetup.actions.browse': 'Przeglądaj',
  'onboarding.localSetup.actions.apply': 'Zastosuj',
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień OMPChamber i przeładowuje konfigurację OMP.',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': 'OMP lokalny niedostępny',
  'onboarding.desktopRecovery.localUnavailable.description': 'Nie można było uruchomić OMP CLI lub nie jest zainstalowany. Zainstaluj OMP lub połącz się z serwerem zdalnym.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan OMPChamber, kondycję OMP, katalogi i projekty.',
  ...
  'aboutDialog.ompchamberVersionLabel': 'Wersja OMPChamber {version}',
  'aboutDialog.ompVersionLabel': 'Wersja OMP {version}',
  ...
  'ompStatusDialog.actions.copy': 'Kopiuj',
  'ompStatusDialog.description': 'Sprawdź bieżący status i diagnostykę OMP.',
  'ompStatusDialog.empty.noData': 'Brak danych.',
  'ompStatusDialog.title': 'Status OMP',
  'ompStatusDialog.toast.copiedDescription': 'Status skopiowany do schowka',
  'ompStatusDialog.toast.copiedTitle': 'Skopiowano',
  'ompStatusDialog.toast.copyFailed': 'Nie udało się skopiować statusu',
  ...
  'ompUpdate.toast.available.title': 'Aktualizacja OMP',
  'ompUpdate.toast.available.description': 'Wersja {version} dostępna.',
  'ompUpdate.toast.actions.update': 'Aktualizuj',
  'ompUpdate.toast.actions.dismiss': 'Odrzuć',
  'ompUpdate.toast.actions.reload': 'Przeładuj OMP',
  'ompUpdate.toast.upgrading.title': 'Aktualizowanie OMP...',
  'ompUpdate.toast.upgrading.description': 'Pozostaw OMPChamber otwarte.',
  'ompUpdate.toast.updated.title': 'OMP zaktualizowany',
  'ompUpdate.toast.updated.description': 'Aktualizacja zainstalowana.',
  'ompUpdate.toast.updated.descriptionWithVersion': 'Wersja {version} zainstalowana.',
  'ompUpdate.toast.failed.title': 'Nie udało się zaktualizować OMP',
  'ompUpdate.toast.failed.description': 'Aktualizacja OMP nie powiodła się.',
  'ompUpdate.toast.reload.message': 'Ponowne uruchamianie OMP...',
  ...
  'onboarding.localSetup.intro': 'OMP to serce OMPChamber — zainstaluj je, aby zacząć.',
  'onboarding.localSetup.actions.checkNow': 'Sprawdź teraz',
  'onboarding.localSetup.status.watching': 'Czekanie na OMP',
