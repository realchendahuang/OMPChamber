...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.ompchamberVersionLabel": "Versão do OMPChamber {version}",
  "aboutDialog.ompVersionLabel": "Versão do OMP {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do OMPChamber, a integridade do OMP, diretórios e projetos.",
  ...
  "chat.emptyState.ompUnreachable": "OMP não está acessível",
  ...
  "ompStatusDialog.title": "Status do OMP",
  "ompStatusDialog.description": "Inspecione o status atual do OMP e os diagnósticos.",
  "ompStatusDialog.actions.copy": "Copiar",
  "ompStatusDialog.empty.noData": "Não há dados.",
  "ompStatusDialog.toast.copiedTitle": "Copiado",
  "ompStatusDialog.toast.copiedDescription": "Status copiado para a área de transferência",
  "ompStatusDialog.toast.copyFailed": "Não foi possível copiar o status",
  ...
  "onboarding.localSetup.title": "Configuração do OMP",
  "onboarding.localSetup.description": "Instale a CLI do OMP para continuar.",
  "onboarding.localSetup.dialog.selectOmpBinary": "Selecionar executável de OMP",
  "onboarding.localSetup.errors.cliNotReady": "A CLI do OMP ainda não está pronta. Confirme que a instalação está completa e tente novamente.",
  "onboarding.localSetup.errors.detectionFailed": "Erro de detecção",
  "onboarding.localSetup.windows.title": "Configuração no Windows",
  "onboarding.localSetup.windows.stepInstallWsl": "Instale o OMP com o comando abaixo.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o OMPChamber não detectar o OMP automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OMP é o coração do OMPChamber. Instale-o para começar.",
  "onboarding.localSetup.docs.windows": "Documentação do OMP",
  "onboarding.localSetup.docs.default": "Documentação do OMP",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Clique para verificar se a CLI do OMP está disponível. Se a verificação funcionar, você entrará automaticamente na tela principal.",
  "onboarding.localSetup.status.watching": "Aguardando OMP",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automaticamente assim que detectado.",
  "onboarding.localSetup.field.alreadyInstalled": "Já está instalado? Defina o caminho da CLI do OMP:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do OMPChamber e recarregue configurações do OMP.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "No Windows, instale e execute o OMP nativamente.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Se a detecção falhar, defina um caminho nativo, como omp.cmd ou omp.exe.",
  "onboarding.localSetup.hint.ensurePath": "Já está instalado? Confira se OMP está no seu PATH.",
  "onboarding.localSetup.hint.setEnv": "Ou defina a variável de ambiente OMP_BINARY (OPENCODE_BINARY ainda é aceita como fallback obsoleto).",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "OMP Local não disponível",
  "onboarding.desktopRecovery.localUnavailable.description": "A CLI do OMP não pôde ser iniciada ou não está instalada. Instale o OMP ou conecte um servidor remoto no lugar dela.",
  ...
  "ompUpdate.toast.available.title": "Atualização do OMP",
  "ompUpdate.toast.available.description": "Versão {version} disponível.",
  "ompUpdate.toast.actions.update": "Atualizar",
  "ompUpdate.toast.actions.dismiss": "Dispensar",
  "ompUpdate.toast.actions.reload": "Recarregar OMP",
  "ompUpdate.toast.upgrading.title": "Atualizando OMP...",
  "ompUpdate.toast.upgrading.description": "Mantenha o OMPChamber aberto.",
  "ompUpdate.toast.updated.title": "OMP atualizado",
  "ompUpdate.toast.updated.description": "Atualização instalada.",
  "ompUpdate.toast.updated.descriptionWithVersion": "Versão {version} instalada.",
  "ompUpdate.toast.failed.title": "Não foi possível atualizar o OMP",
  "ompUpdate.toast.failed.description": "A atualização do OMP falhou.",
  ...
  "ompchamberLogo.aria.logo": "Logo do OMPChamber",
