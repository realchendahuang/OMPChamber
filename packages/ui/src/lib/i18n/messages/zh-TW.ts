...
export const dict: Record<I18nKey, string> = {
  ...
  'aboutDialog.ompchamberVersionLabel': 'OMPChamber 版本 {version}',
  'aboutDialog.ompVersionLabel': 'OMP 版本 {version}',
  ...
  'aboutDialog.diagnosticsDescription': '包含 OMPChamber 狀態、OMP 健康資訊、目錄和專案。',
  ...
  'chat.emptyState.ompUnreachable': '無法連線 OMP',
  ...
  'ompStatusDialog.title': 'OMP 狀態',
  'ompStatusDialog.description': '查看目前 OMP 狀態與診斷資訊。',
  'ompStatusDialog.actions.copy': '複製',
  'ompStatusDialog.empty.noData': '無資料。',
  'ompStatusDialog.toast.copiedTitle': '已複製',
  'ompStatusDialog.toast.copiedDescription': '狀態已複製到剪貼簿',
  'ompStatusDialog.toast.copyFailed': '複製狀態失敗',
  ...
  'onboarding.localSetup.title': '設定 OMP',
  'onboarding.localSetup.description': '安裝 OMP CLI 以繼續。',
  'onboarding.localSetup.dialog.selectOmpBinary': '選擇 OMP 執行檔',
  'onboarding.localSetup.errors.cliNotReady': 'OMP CLI 尚未就緒。請確認安裝完成後重試。',
  'onboarding.localSetup.errors.detectionFailed': '偵測失敗',
  'onboarding.localSetup.windows.title': 'Windows 設定',
  'onboarding.localSetup.windows.stepInstallWsl': '使用下方命令安裝 OMP。',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': '如果 OMPChamber 未自動偵測到 OMP，請在下方設定執行檔路徑。',
  'onboarding.localSetup.intro': 'OMP 是 OMPChamber 的核心，先安裝它即可開始。',
  'onboarding.localSetup.docs.windows': 'OMP 文件',
  'onboarding.localSetup.docs.default': 'OMP 文件',
  ...
  'onboarding.localSetup.helper.checkAndContinue': '點擊偵測 OMP CLI 是否可用。成功後將自動進入主介面。',
  'onboarding.localSetup.status.watching': '正在等待 OMP',
  'onboarding.localSetup.status.autoContinue': '偵測到後將自動繼續。',
  'onboarding.localSetup.field.alreadyInstalled': '已安裝？設定 OMP CLI 路徑：',
  ...
  'onboarding.localSetup.helper.saveAndReload': '將儲存到 OMPChamber 設定並重新載入 OMP 設定。',
  'onboarding.localSetup.remotePreference': '更希望使用遠端伺服器？',
  'onboarding.localSetup.actions.connectRemoteServer': '連接遠端伺服器 →',
  'onboarding.localSetup.windows.hintInstallInWsl': '在 Windows 上，請原生安裝並執行 OMP。',
  'onboarding.localSetup.windows.hintDetectionFailed': '若偵測失敗，請設定原生路徑，例如 omp.cmd 或 omp.exe。',
  'onboarding.localSetup.hint.ensurePath': '已安裝？請確認 OMP 在你的 PATH 中。',
  'onboarding.localSetup.hint.setEnv': '或設定 OMP_BINARY 環境變數（OPENCODE_BINARY 仍可作為已棄用的備用選項）。',
  ...
  'onboarding.desktopRecovery.localUnavailable.title': '本地 OMP 無法使用',
  'onboarding.desktopRecovery.localUnavailable.description': 'OMP CLI 無法啟動或未安裝。請安裝 OMP，或改為連接遠端伺服器。',
  ...
  'ompUpdate.toast.available.title': 'OMP 更新',
  'ompUpdate.toast.available.description': '版本 {version} 可安裝。',
  'ompUpdate.toast.actions.update': '更新',
  'ompUpdate.toast.actions.dismiss': '忽略',
  'ompUpdate.toast.actions.reload': '重新載入 OMP',
  'ompUpdate.toast.upgrading.title': '正在更新 OMP...',
  'ompUpdate.toast.upgrading.description': '請保持 OMPChamber 開啟。',
  'ompUpdate.toast.updated.title': 'OMP 已更新',
  'ompUpdate.toast.updated.description': '更新已安裝。',
  'ompUpdate.toast.updated.descriptionWithVersion': '版本 {version} 已安裝。',
  'ompUpdate.toast.failed.title': '無法更新 OMP',
  'ompUpdate.toast.failed.description': 'OMP 升級失敗。',
  'ompUpdate.toast.reload.message': '正在重新啟動 OMP...',
  ...
  'ompchamberLogo.aria.logo': 'OMPChamber 標誌',
