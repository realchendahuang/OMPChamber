...
export const dict: Record<I18nKey, string> = {
  ...
  "aboutDialog.ompchamberVersionLabel": "Versión de OMPChamber {version}",
  "aboutDialog.ompVersionLabel": "Versión de OMP {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de OMPChamber, el estado de OMP, directorios y proyectos.",
  ...
  "chat.emptyState.ompUnreachable": "OMP no es accesible",
  ...
  "ompStatusDialog.title": "Estado de OMP",
  "ompStatusDialog.description": "Inspecciona el estado actual de OMP y diagnósticos.",
  "ompStatusDialog.actions.copy": "Copiar",
  "ompStatusDialog.empty.noData": "No hay datos.",
  "ompStatusDialog.toast.copiedTitle": "Copiado",
  "ompStatusDialog.toast.copiedDescription": "Estado copiado al portapapeles",
  "ompStatusDialog.toast.copyFailed": "No se pudo copiar el estado",
  ...
  "onboarding.localSetup.title": "Configuración de OMP",
  "onboarding.localSetup.description": "Instala la CLI de OMP para continuar.",
  "onboarding.localSetup.dialog.selectOmpBinary": "Seleccionar ejecutable de OMP",
  "onboarding.localSetup.errors.cliNotReady": "La CLI de OMP aún no está lista. Confirma que la instalación está completa y intenta de nuevo.",
  ...
  "onboarding.localSetup.windows.stepInstallWsl": "Instala OMP con el comando siguiente.",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si OMPChamber no detecta OMP automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OMP es el corazón de OMPChamber. Instálalo para empezar.",
  "onboarding.localSetup.docs.windows": "Documentación de OMP",
  "onboarding.localSetup.docs.default": "Documentación de OMP",
  ...
  "onboarding.localSetup.helper.checkAndContinue": "Haz clic para verificar si la CLI de OMP está disponible. Si la verificación funciona, entrarás automáticamente en la pantalla principal.",
  "onboarding.localSetup.status.watching": "Esperando OMP",
  "onboarding.localSetup.status.autoContinue": "Continuaremos automáticamente al detectarlo.",
  "onboarding.localSetup.field.alreadyInstalled": "¿Ya está instalado? Establece la ruta de la CLI de OMP:",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de OMPChamber y recarga la configuración de OMP.",
  ...
  "onboarding.localSetup.windows.hintInstallInWsl": "En Windows, instala y ejecuta OMP de forma nativa.",
  "onboarding.localSetup.windows.hintDetectionFailed": "Si la detección falla, establece una ruta nativa como omp.cmd u omp.exe.",
  "onboarding.localSetup.hint.ensurePath": "¿Ya está instalado? Asegúrate de que OMP esté en tu PATH.",
  "onboarding.localSetup.hint.setEnv": "O establece la variable de entorno OMP_BINARY (OPENCODE_BINARY sigue aceptándose como alternativa obsoleta).",
  ...
  "onboarding.desktopRecovery.localUnavailable.title": "OMP Local no disponible",
  "onboarding.desktopRecovery.localUnavailable.description": "La CLI de OMP no pudo iniciarse o no está instalado. Instala OMP o conecta a un servidor remoto en su lugar.",
  ...
  "ompUpdate.toast.available.title": "Actualización de OMP",
  "ompUpdate.toast.available.description": "Versión {version} disponible.",
  "ompUpdate.toast.actions.update": "Actualizar",
  "ompUpdate.toast.actions.dismiss": "Descartar",
  "ompUpdate.toast.actions.reload": "Recargar OMP",
  "ompUpdate.toast.upgrading.title": "Actualizando OMP...",
  "ompUpdate.toast.upgrading.description": "Mantén OMPChamber abierto.",
  "ompUpdate.toast.updated.title": "OMP actualizado",
  "ompUpdate.toast.updated.description": "Actualización instalada.",
  "ompUpdate.toast.updated.descriptionWithVersion": "Versión {version} instalada.",
  "ompUpdate.toast.failed.title": "No se pudo actualizar OMP",
  "ompUpdate.toast.failed.description": "La actualización de OMP falló.",
  "ompUpdate.toast.reload.message": "Reiniciando OMP...",
  ...
  "ompchamberLogo.aria.logo": "Logo de OMPChamber",
