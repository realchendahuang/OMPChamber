...
# Usage: curl -fsSL https://raw.githubusercontent.com/btriapitsyn/ompchamber/main/scripts/install.sh | bash

set -euo pipefail

PACKAGE_NAME="@ompchamber/web"
BIN_NAME="ompchamber"
MIN_NODE_VERSION=22
...
EOF
    ...
    echo ""
    echo "  Prerequisites:"
    echo "    Make sure the OMP CLI is installed: omp --version"
    echo ""
  else
    echo ""
